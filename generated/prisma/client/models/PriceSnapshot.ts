...
export type PriceSnapshotWhereInput = {
  ...
  cardId?: Prisma.StringFilter<"PriceSnapshot"> | string
  source?: Prisma.StringFilter<"PriceSnapshot"> | string
  condition?: Prisma.EnumConditionFilter<"PriceSnapshot"> | $Enums.Condition
...
export type PriceSnapshotScalarWhereWithAggregatesInput = {
  ...
  cardId?: Prisma.StringWithAggregatesFilter<"PriceSnapshot"> | string
  source?: Prisma.StringWithAggregatesFilter<"PriceSnapshot"> | string
  condition?: Prisma.EnumConditionWithAggregatesFilter<"PriceSnapshot"> | $Enums.Condition
...
export type PriceSnapshotOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "cardId" | "source" | "condition" | "price" | "currency" | "recordedAt", ExtArgs["result"]["priceSnapshot"]>
...
export interface PriceSnapshotFieldRefs {
  ...
  readonly condition: Prisma.FieldRef<"PriceSnapshot", 'Condition'>
